...
<div class="barra-inferior" id="barra-inferior">
    ...
    <img src="/ForoDeDiscucion/assets/imagenes/chat.png" alt="menu-mensaje" class="imagen-menu" id="menu-mensajes">
    <img src="/ForoDeDiscucion/assets/imagenes/usuario.png" alt="menu-perfil" class="imagen-menu" id="menu-perfil">
</div>

<!-- No ecuentro razon para que las imagenes no funcionen  -->
